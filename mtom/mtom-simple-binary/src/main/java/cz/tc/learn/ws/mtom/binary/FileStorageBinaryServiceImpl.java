...
public class FileStorageBinaryServiceImpl implements FileStorageBinaryPort {
    
    private static final Logger LOG = Logger.getLogger(FileStorageBinaryServiceImpl.class.getName());
