...
public class FileStorageStreamServiceImplV3 implements FileStorageStreamPort {
    
    private static final Logger LOG = Logger.getLogger(FileStorageStreamServiceImplV3.class.getName());
    ...
    @MTOM(enabled = true, threshold = 60)
    @Override
