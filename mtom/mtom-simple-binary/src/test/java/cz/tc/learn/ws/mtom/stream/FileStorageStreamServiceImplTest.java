 ...
 * @author tomas.cejka
 */
public class FileStorageStreamServiceImplTest {

    private static Logger LOG = Logger.getLogger(FileStorageStreamServiceImplTest.class.getName());
    ...
    public static void beforeClass() throws Exception {
        ...
        endpoint = Endpoint.publish(URL_SERVICE, new FileStorageStreamServiceImpl());
    }
