 ...
 * @author tomas.cejka
 */
public class FileStorageStreamServiceImplV3Test {

    private static Logger LOG = Logger.getLogger(FileStorageStreamServiceImplV3Test.class.getName());
    ...
    public static void beforeClass() throws Exception {
        ...
        endpoint = Endpoint.publish(URL_SERVICE, new FileStorageStreamServiceImplV3());
    }
    ...
    public void testTryMtomFeature_DownloadBinary() throws Exception {
        String filename=FileStorageStreamServiceImpl.SAMPLE_FILE_XML;
        MTOMFeature feature = new MTOMFeature(true, 600);
        port = service.getPort(portClazz, feature);
        FileStreamType file = port.downloadStream(filename);
        Assert.assertEquals(filename, file.getFileName());
    }  
