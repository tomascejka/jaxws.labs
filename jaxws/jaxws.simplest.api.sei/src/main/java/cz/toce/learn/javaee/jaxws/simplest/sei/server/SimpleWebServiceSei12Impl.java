...
public class SimpleWebServiceSei12Impl implements SimplestWebServiceApiPortType {

    private static final Logger LOG = Logger.getLogger(SimpleWebServiceSei12Impl.class.getName());
