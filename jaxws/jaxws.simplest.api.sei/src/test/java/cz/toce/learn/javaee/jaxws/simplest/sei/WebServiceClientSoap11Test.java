...
import static cz.toce.learn.javaee.jaxws.simplest.sei.WebServicePublisher.SERVICE_URL_11;
...
public class WebServiceClientSoap11Test {
    ...
    public static void before() throws Exception {
        endpoint = Endpoint.publish(SERVICE_URL_11, new SimpleWebServiceSei11Impl());
    }
    ...
    public void setUp() throws Exception {
        ...
        tested = service.getSimplestWebServiceApiSoap11Http();
    }
    ...
    public void testHelloRuntimeExceptionWithMessage () {
        ...
        thrown.expectMessage(SimpleWebServiceSei11Impl.RUNTIME_EXCEPTION_MESSAGE);
        // -- testovana metoda
        tested.helloRuntimeException(request);
    }
    ...
    public void testHelloCheckedExceptionWithMessage () throws InternalErrorExceptionFault {
        ...
        thrown.expectMessage(SimpleWebServiceSei11Impl.CHECKED_EXCEPTION_MESSAGE);
        // -- testovana metoda
        tested.helloCheckedException(request);
    }
