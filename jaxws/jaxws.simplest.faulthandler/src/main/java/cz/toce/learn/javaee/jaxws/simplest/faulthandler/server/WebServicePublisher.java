...
public class WebServicePublisher {
    public static final String SERVICE_URL = "http://localhost:8082/ws/SimplestWebServiceFaultHandler";
    /**
    ...
    public static void main(String[] args) {
        Endpoint.publish(SERVICE_URL, new SimpleWebServiceFaultHandlerImpl());
        System.out.println("--");
