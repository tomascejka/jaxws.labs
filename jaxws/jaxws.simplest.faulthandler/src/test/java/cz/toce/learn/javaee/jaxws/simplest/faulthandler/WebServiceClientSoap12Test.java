...
import static cz.toce.learn.javaee.jaxws.simplest.faulthandler.WebServicePublisher.SERVICE_URL_12;
...
public class WebServiceClientSoap12Test {
    ...
    public static void before() throws Exception {
        endpoint = Endpoint.publish(SERVICE_URL_12, new SimpleWebServiceFaultHandler12Impl());
    }
    ...
    public void setUp() throws Exception {
        ...
        tested = service.getSimpleWebServiceFaultHandlerSoap12Http();
        // -- Pridani handleru
    ...
    public void testHelloRuntimeExceptionWithMessage () {
        ...
        thrown.expectMessage(SimpleWebServiceFaultHandler12Impl.RUNTIME_EXCEPTION_MESSAGE);
        // -- testovana metoda
        tested.helloRuntimeException(request);
    }
    ...
    public void testHelloCheckedExceptionWithMessage () throws InternalErrorExceptionFault {
        ...
        thrown.expectMessage(SimpleWebServiceFaultHandler12Impl.CHECKED_EXCEPTION_MESSAGE);
        // -- testovana metoda
        tested.helloCheckedException(request);
    }
